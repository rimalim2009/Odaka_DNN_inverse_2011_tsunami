...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1100_TC_odaka_2"
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1100_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1100_TC_odaka_2/'
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1100_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1100_TC_odaka_2/5000/'
...
np.savetxt('outcrop_result_g6_g300_j2_roi1100_2_TC_odaka_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
...
estimated_icond=np.loadtxt('outcrop_result_g6_g300_j2_roi1100_2_TC_odaka_2rev.txt', delimiter=',')
start = time.time()
fmodel.read_setfile("config_g6_300grid_j2_gs_round.ini")
(x,C,x_dep,deposit) = fmodel.forward(estimated_icond)
np.savetxt('eta_estimated_thickness_5K_g6_j2_roi1000_2.csv', deposit, delimiter=',')
np.savetxt('eta_estimated_Distance_5K_g6_j2_roi1000_2.csv', x_dep,delimiter=',')
estimated_dep_thickness_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_thickness_5K_g6_j2_roi1000_2.csv', delimiter=','))
estimated_dep_thickness_5000=pd.DataFrame(estimated_dep_thickness_5000,columns=['841','595','420','297','210','149'])
estimated_dep_distance_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_Distance_5K_g6_j2_roi1000_2.csv', delimiter=','))
...
np.savetxt('estimated_dep_5K_g6_j2_roi1000_2.csv',estimated_dep_5000,delimiter=',')
...
for i in range(gclass):
    ...
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1100_2.png")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1100_2.eps")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1100_2.pdf")
plt.show()
...
with open('output_final_j2_roi1100_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi1100_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_1100_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1200_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1200_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1200_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1200_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1200_TC_odaka_2/5000/'
...
hfont = {'fontname':'Century Gothic'}
textcol = 'k'
xymin=[2000,2.0,1.5,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001]
xymax=[4500,10.0,12.0,0.02,0.02,0.02,0.02,0.02,0.02]
xstep=[500,1.5,1.5,0.005,0.005,0.005,0.005,0.005,0.005]
stepmin=[2000,1.0,2.0,0.000,0.0000,0.0000,0.0000,0.0000,0.0000]
stepmax=[4550,10.5,13.0,0.025,0.025,0.025,0.025,0.025,0.025]
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)], label='estimated')
for j in range(gclass):
...
np.savetxt('outcrop_result_g6_g300_j2_roi1200_2_TC_5000_odaka_cubic_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
for i in range(gclass):
    plt.plot(outcrop['distance'], outcrop[gclass_name[i]],'o', label='Measured')
...
estimated_icond=np.loadtxt('outcrop_result_g6_g300_j2_roi1200_2_TC_5000_odaka_cubic_2rev.txt', delimiter=',')
start = time.time()
fmodel.read_setfile("config_g6_300grid_j2_gs_round.ini")
(x,C,x_dep,deposit) = fmodel.forward(estimated_icond)
np.savetxt('eta_estimated_thickness_5K_g6_j2_roi1200_2.csv', deposit, delimiter=',')
np.savetxt('eta_estimated_Distance_5K_g6_j2_roi1200_2.csv', x_dep,delimiter=',')
estimated_dep_thickness_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_thickness_5K_g6_j2_roi1200_2.csv', delimiter=','))
estimated_dep_thickness_5000=pd.DataFrame(estimated_dep_thickness_5000,columns=['841','595','420','297','210','149'])
estimated_dep_distance_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_Distance_5K_g6_j2_roi1200_2.csv', delimiter=','))
estimated_dep_distance_5000=pd.DataFrame(estimated_dep_distance_5000,columns=['distance'])
estimated_dep_5000=pd.concat([estimated_dep_distance_5000,estimated_dep_thickness_5000],axis=1)
np.savetxt('estimated_dep_5K_g6_j2_roi1200_2.csv',estimated_dep_5000,delimiter=',')
...
for i in range(gclass):
    ...
    plt.ylabel('Volume per unit area (m)', size = 14, **hfont)
    plt.legend(fontsize=10)
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1200_2_5000.png")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1200_2_5000.eps")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1200_2_5000_2.pdf")
plt.show()
...
with open('output_final_j2_roi1200_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi1200_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_1200_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1300_2_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1300_2_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1300_2_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1300_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1300_2_TC_odaka_2/5000/'
...
np.savetxt('outcrop_result_g6_g300_j2_roi1300_2_TC_cubic_odaka_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
for i in range(gclass):
    plt.plot(outcrop['distance'], outcrop[gclass_name[i]],'o', label='Measured')
...
estimated_icond=np.loadtxt('outcrop_result_g6_g300_j2_roi1300_2_TC_cubic_odaka_2rev.txt', delimiter=',')
start = time.time()
fmodel.read_setfile("config_g6_300grid_j2_gs_round.ini")
(x,C,x_dep,deposit) = fmodel.forward(estimated_icond)
np.savetxt('eta_estimated_thickness_5K_g6_j2_roi1300_2.csv', deposit, delimiter=',')
np.savetxt('eta_estimated_Distance_5K_g6_j2_roi1300_2.csv', x_dep,delimiter=',')
estimated_dep_thickness_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_thickness_5K_g6_j2_roi1300_2.csv', delimiter=','))
estimated_dep_thickness_5000=pd.DataFrame(estimated_dep_thickness_5000,columns=['841','595','420','297','210','149'])
estimated_dep_distance_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_Distance_5K_g6_j2_roi1300_2.csv', delimiter=','))
estimated_dep_distance_5000=pd.DataFrame(estimated_dep_distance_5000,columns=['distance'])
estimated_dep_5000=pd.concat([estimated_dep_distance_5000,estimated_dep_thickness_5000],axis=1)
np.savetxt('estimated_dep_5K_g6_j2_roi1300_2.csv',estimated_dep_5000,delimiter=',')
...
for i in range(gclass):
    ...
    plt.ylabel('Volume per unit area (m)', size = 14, **hfont)
    plt.legend(fontsize=10)
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1300_2.png")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1300_2.eps")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1300_2.pdf")
plt.show()
...
with open('output_final_j2_roi1300_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi1300_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_1300_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1400_2_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1400_2_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1400_2_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1400_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1400_2_TC_odaka_2/5000/'
...
np.savetxt('outcrop_result_g6_g300_j2_roi1400_2_TC_odaka_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
plt.legend()
plt.show()
...
import matplotlib.pyplot as plt
import pandas as pd
import Forward_model_for_DNN_J2_odaka_rw2200 as fmodel
import time
import ipdb
get_ipython().run_line_magic('matplotlib', 'inline')
...
estimated_icond=np.loadtxt('outcrop_result_g6_g300_j2_roi1400_2_TC_odaka_2rev.txt', delimiter=',')
start = time.time()
fmodel.read_setfile("config_g6_300grid_j2_gs_round.ini")
(x,C,x_dep,deposit) = fmodel.forward(estimated_icond)
np.savetxt('eta_estimated_thickness_5K_g6_j2_roi1400_2.csv', deposit, delimiter=',')
np.savetxt('eta_estimated_Distance_5K_g6_j2_roi1400_2.csv', x_dep,delimiter=',')
estimated_dep_thickness_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_thickness_5K_g6_j2_roi1400_2.csv', delimiter=','))
estimated_dep_thickness_5000=pd.DataFrame(estimated_dep_thickness_5000,columns=['841','595','420','297','210','149'])
estimated_dep_distance_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_Distance_5K_g6_j2_roi1400_2.csv', delimiter=','))
estimated_dep_distance_5000=pd.DataFrame(estimated_dep_distance_5000,columns=['distance'])
estimated_dep_5000=pd.concat([estimated_dep_distance_5000,estimated_dep_thickness_5000],axis=1)
np.savetxt('estimated_dep_5K_g6_j2_roi1400_2.csv',estimated_dep_5000,delimiter=',')
...
for i in range(gclass):
    ...
    plt.ylabel('Volume per unit area (m)', size = 14, **hfont)
    plt.legend(fontsize=10)
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1400_2.png")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1400_2.eps")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1400_2.pdf")
plt.show()
...
if not "model" in locals():
    model = load_model(resdir+'model3.hdf5')
gclass = 6
gclass_label = ['841','595','420','297','210','149']
topodx = 15.0
coord_num = int(model.layers[0].input_shape[1]/gclass)
min_x, max_x = np.loadtxt(datadir + 'x_minmax.txt', delimiter=',')
y_min = np.loadtxt(datadir + 'icond_min.txt', delimiter=',')
...
with open('output_final_j2_roi1400_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi1400_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_1400_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1600_2_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1600_2_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1600_2_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1600_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1600_2_TC_odaka_2/5000/'
...
estimated_icond=np.loadtxt('outcrop_result_g6_g300_j2_roi1600_2_TC_odaka_2rev.txt', delimiter=',')
start = time.time()
fmodel.read_setfile("config_g6_300grid_j2_gs_round.ini")
(x,C,x_dep,deposit) = fmodel.forward(estimated_icond)
np.savetxt('eta_estimated_thickness_5K_g6_j2_roi1600_2.csv', deposit, delimiter=',')
np.savetxt('eta_estimated_Distance_5K_g6_j2_roi1600_2.csv', x_dep,delimiter=',')
estimated_dep_thickness_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_thickness_5K_g6_j2_roi1600_2.csv', delimiter=','))
estimated_dep_thickness_5000=pd.DataFrame(estimated_dep_thickness_5000,columns=['841','595','420','297','210','149'])
estimated_dep_distance_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_Distance_5K_g6_j2_roi1600_2.csv', delimiter=','))
estimated_dep_distance_5000=pd.DataFrame(estimated_dep_distance_5000,columns=['distance'])
estimated_dep_5000=pd.concat([estimated_dep_distance_5000,estimated_dep_thickness_5000],axis=1)
...
for i in range(gclass):
    ...
    plt.ylabel('Volume per unit area (m)', size = 14, **hfont)
    plt.legend(fontsize=10)
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1600_2.png")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1600_2.eps")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1600_2.pdf")
plt.show()
...
with open('output_final_j2_roi1600_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi1600_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_1600_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1700_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1700_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1700_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1700_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1700_TC_odaka_2/5000/'
...
np.savetxt('outcrop_result_g6_g300_j2_roi1700_2_TC_cubic_odaka_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
for i in range(gclass):
    plt.plot(outcrop['distance'], outcrop[gclass_name[i]],'o', label='Measured')
...
estimated_icond=np.loadtxt('outcrop_result_g6_g300_j2_roi1700_2_TC_cubic_odaka_2rev.txt', delimiter=',')
start = time.time()
fmodel.read_setfile("config_g6_300grid_j2_gs_round.ini")
(x,C,x_dep,deposit) = fmodel.forward(estimated_icond)
np.savetxt('eta_estimated_thickness_5K_g6_j2_roi1700.csv', deposit, delimiter=',')
np.savetxt('eta_estimated_Distance_5K_g6_j2_roi1700.csv', x_dep,delimiter=',')
estimated_dep_thickness_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_thickness_5K_g6_j2_roi1700.csv', delimiter=','))
estimated_dep_thickness_5000=pd.DataFrame(estimated_dep_thickness_5000,columns=['841','595','420','297','210','149'])
estimated_dep_distance_5000=np.transpose(np.loadtxt('/home/rimali2009/Journal_2/'+'eta_estimated_Distance_5K_g6_j2_roi1700.csv', delimiter=','))
estimated_dep_distance_5000=pd.DataFrame(estimated_dep_distance_5000,columns=['distance'])
estimated_dep_5000=pd.concat([estimated_dep_distance_5000,estimated_dep_thickness_5000],axis=1)
np.savetxt('estimated_dep_5K_g6_j2_roi1700.csv',estimated_dep_5000,delimiter=',')
...
for i in range(gclass):
    ...
    plt.ylabel('Volume per unit area (m)', size = 14, **hfont)
    plt.legend(fontsize=10)
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1700.png")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1700.eps")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1700.pdf")
plt.show()
...
with open('output_final_j2_roi1700_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi1700_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5jk','$C_6$jk']
jk_er=[]
with open('jk_e_1700_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1800_2_TC_odaka_2_TN"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1800_2_TC_odaka_2_TN/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1800_2_TC_odaka_2_TN/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
    ...
    #Execution of learning
    testcases = [500,1000,2000,3000,4000,5000]
    for i in range(len(testcases)):
        resdir_case = resdir + '{}/'.format(testcases[i])        
        if not os.path.exists(resdir_case):
            os.mkdir(resdir_case)
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1000_2_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1000_2_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1000_2_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1000_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1000_2_TC_odaka_2/5000/'
...
xymax=[4500,10.0,12.0,0.02,0.02,0.02,0.02,0.02,0.02]
xstep=[500,1.5,1.5,0.005,0.005,0.005,0.005,0.005,0.005]
stepmin=[20250,10.5,13.0,0.025,0.025,0.025,0.025,0.025,0.025]
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)], label='estimated')
for j in range(gclass):
    plt.plot(x,X_test_norm[0,j * coord_num : (j+1) * coord_num],'o',label='test')
...
gname_label = ["841 ${\mu}m$","595 ${\mu}m$","420 ${\mu}m$","297 ${\mu}m$", "210 ${\mu}m$","149 ${\mu}m$"]
gclass_name=['841','595','420','297','210','149']
...
#Output results
#print(test_result_outcrop_add)
np.savetxt('outcrop_result_g6_g300_j2_roi1000_2_TC_cubic_odaka_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
for i in range(gclass):
    plt.plot(outcrop['distance'], outcrop[gclass_name[i]],'o', label='Measured')
...
estimated_icond=np.loadtxt('outcrop_result_g6_g300_j2_roi1000_2_TC_cubic_odaka_2rev.txt', delimiter=',')
start = time.time()
fmodel.read_setfile("config_g6_300grid_j2_gs_round.ini")
(x,C,x_dep,deposit) = fmodel.forward(estimated_icond)
np.savetxt('eta_estimated_thickness_5K_g6_j2_roi1000_2.csv', deposit, delimiter=',')
...
for i in range(gclass):
    ...
    plt.ylabel('Volume per unit area (m)', size = 14, **hfont)
    plt.legend(fontsize=10)
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1000_2.png")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1000_2.eps")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi1000_2.pdf")
plt.show()
...
with open('output_final_j2_roi1000_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi1000_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_1000_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1900_2_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1900_2_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1900_2_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1900_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1900_2_TC_odaka_2/5000/'
...
np.savetxt('outcrop_result_g6_g300_j2_roi1900_2_TC_cubic_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
plt.legend()
plt.show()
...
with open('output_final_j2_roi1900_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi1900_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5jk','$C_6$jk']
jk_er=[]
with open('jk_e_1900_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi2000_TC_odaka"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi2000_TC_odaka/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi2000_TC_odaka/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi2000_TC_odaka/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi2000_TC_odaka/5000/'
...
hfont = {'fontname':'Century Gothic'}
textcol = 'k'
xymin=[2200,1.5,1.5,0.0001,0.0001,0.0001,0.0001,0.0001,0.0001]
xymax=[4500,10.0,12.0,0.02,0.02,0.02,0.02,0.02,0.02]
xstep=[500,1.5,1.5,0.005,0.005,0.005,0.005,0.005,0.005]
stepmin=[2200,1.0,2.0,0.000,0.0000,0.0000,0.0000,0.0000,0.0000]
stepmax=[4550,10.5,13.0,0.025,0.025,0.025,0.025,0.025,0.025]
...
estimated_icond=np.loadtxt('outcrop_result_g6_g300_j2_roi2000_2_TCrev.txt', delimiter=',')
start = time.time()
fmodel.read_setfile("config_g6_300grid_j2_gs_round.ini")
(x,C,x_dep,deposit) = fmodel.forward(estimated_icond)
np.savetxt('eta_estimated_thickness_5K_g6_j2_roi1000_2.csv', deposit, delimiter=',')
...
for i in range(gclass):
    ...
    plt.ylabel('Volume per unit area (m)', size = 14, **hfont)
    plt.legend(fontsize=10)
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi2000_2.png")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi2000_2.eps")
    plt.savefig("thickness_distance_curve_5000_g6_j2_roi2000_2.pdf")
plt.show()
...
with open('output_final_j2_roi2000_TCrev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi2000_TCrev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5jk','$C_6$jk']
jk_er=[]
with open('jk_e_2000_j2_6rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi2100_2_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi2100_2_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi2100_2_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi2100_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi2100_2_TC_odaka_2/5000/'
...
np.savetxt('outcrop_result_g6_g300_j2_roi2100_2_TC_odaka_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
plt.legend()
plt.show()
...
with open('output_final_j2_roi2100_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi2100_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_2100_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi2200_2_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi2200_2_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi2200_2_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi2200_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi2200_2_TC_odaka_2/5000/'
...
np.savetxt('outcrop_result_g6_g300_j2_roi2200_2_TC_cubic_odaka_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
plt.legend()
plt.show()
...
with open('output_final_j2_roi2200_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi2200_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_2200_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi2300_2_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi2300_2_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi2300_2_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi2300_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi2300_2_TC_odaka_2/5000/'
...
#Output results
#print(test_result_outcrop_add)
np.savetxt('outcrop_result_g6_g300_j2_roi2300_2_TC_odaka_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
plt.legend()
plt.show()
...
with open('output_final_j2_roi2300_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi2300_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_2300_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi2400_2_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi2400_2_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi2400_2_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi2400_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi2400_2_TC_odaka_2/5000/'
...
xstep=[500,1.5,1.5,0.005,0.005,0.005,0.005,0.005,0.005]
stepmin=[2200,1.0,2.0,0.000,0.0000,0.0000,0.0000,0.0000,0.0000]
stepmax=[4500,10.5,13.0,0.025,0.025,0.025,0.025,0.025,0.025]
...
#Read outcrop data
#dist_max = 24000. #Distance of distal end of learning data
outcrop = pd.read_csv('../Journal_2/odaka_increased_class_edit3.csv')
...
np.savetxt('outcrop_result_g6_g300_j2_roi2400_2_TC_cubic_odaka_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
plt.legend()
plt.show()
...
with open('output_final_j2_roi2400_TC_6_2rev.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi2400_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_2400_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1800_2_TC_odaka_2_round"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
connect_dataset(file_list, initial_conditions, outputdir, test_data_num=500, gclass_num=6, topodx=15., roi=1800)
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1800_2_TC_odaka_2_round/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1800_2_TC_odaka_2_round/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1800_2_TC_odaka_2_round/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1800_2_TC_odaka_2_round/5000/'
#Initial setting
if not "model" in locals(): 
    model = load_model(resdir+'model3.hdf5')
#gclass = 3
...
#Output results
#print(test_result_outcrop_add)
np.savetxt('outcrop_result_g6_g300_j2_roi1800_2_TC_cubic_odaka_2.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
plt.legend()
plt.show()
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1800_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1800_2_TC_odaka_2/5000/'
#Initial setting
if not "model" in locals(): 
    model = load_model(resdir+'model3.hdf5')
...
with open('output_final_j2_roi1800_TC_6_2.csv', 'w') as outfile:
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi1800_TC_6_2.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_1800_j2_6_2.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1500_2_TC_odaka_2"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1500_2_TC_odaka_2/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1500_2_TC_odaka_2/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1500_2_TC_odaka_2/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1500_2_TC_odaka_2/5000/'
#Initial setting
if not "model" in locals(): 
    model = load_model(resdir+'model3.hdf5')
...
#Output results
#print(test_result_outcrop_add)
np.savetxt('outcrop_result_g6_g300_j2_roi1500_2_TC_odaka_2rev.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
plt.legend()
plt.show()
...
a = pd.read_csv('../Journal_2/odaka_increased_class_edit3.csv', delimiter=',')
print(a)
y = pd.DataFrame()
output = []

with open('output_final_j2_roi1500_TC_6_2rev.csv', 'w') as outfile:

    # x=[]
    for index in range(len(a)):
        df = y.append(pd.read_csv('../Journal_2/odaka_increased_class_edit3.csv', skiprows=[index+1]))
        print(df)
        df = df.sort_values('distance')
        thick_interp = np.zeros([1, coord_num*gclass])
        x = np.arange(0, coord_num*topodx, topodx)
...
hfont = {'fontname': 'Century Gothic'}
textcol = 'k'
resi = np.loadtxt('output_final_j2_roi1500_TC_6_2rev.csv', delimiter=',')
titlelabel = ['Max. Inundation Lengthjk','Flow Velocityjk', 'Max Flow depthjk',
              '$C_1$jk', '$C_2$jk', '$C_3$jk', '$C_4$jk','$C_5$jk','$C_6$jk']
jk_er=[]
with open('jk_e_1500_j2_6_2rev.txt','wb') as ftext:
    for i in range(len(titlelabel)):
        plt.figure(num=None, dpi=250, facecolor='w', edgecolor='k')
        plt.hist(resi[:, i], bins=35)
        mean = sum(resi[:,i]) / len(resi[:,i])
...
if __name__=="__main__":
    ...
    if not os.path.exists(parent_dir):
        os.mkdir(parent_dir)
    outputdir = parent_dir + "/data_g6_j2_roi1800_2_TC_odaka_2_round_1"
    file_list = ['/home/rimali2009/Journal_2/eta_5000_g6_300grid_j2_odaka_round_2200.csv']
    initial_conditions = ['/home/rimali2009/Journal_2/start_param_random_5000_j2_odaka_round_2200.csv']
    connect_dataset(file_list, initial_conditions, outputdir, test_data_num=500, gclass_num=6, topodx=15., roi=1800)
...
if __name__ == "__main__":
    ...
    #Reading data  
    datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1800_2_TC_odaka_2_round_1/'
    resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1800_2_TC_odaka_2_round_1/'
    if not os.path.exists(resdir):
        os.mkdir(resdir)
...
datadir = '/home/rimali2009/Journal_2/data_g6_j2_roi1800_2_TC_odaka_2_round_1/'
resdir = '/home/rimali2009/Journal_2/result_g6_j2_roi1800_2_TC_odaka_2_round_1/5000/'
...
#Output results
#print(test_result_outcrop_add)
np.savetxt('outcrop_result_g6_g300_j2_roi1800_2_TC_cubic_odaka_round.txt',test_result_outcrop, delimiter=',')
for i in range(len(gclass_label)):
    plt.plot(x,thick_interp[0,coord_num * i:coord_num * (i+1)],label=gclass_label[i])
for i in range(gclass):
    plt.plot(outcrop['distance'], outcrop[gclass_name[i]],'o', label='Measured')
